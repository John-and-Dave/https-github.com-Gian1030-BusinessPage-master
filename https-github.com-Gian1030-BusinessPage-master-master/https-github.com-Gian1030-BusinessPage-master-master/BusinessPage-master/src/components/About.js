   ...
   handleScroll = () =>{
    ...
    render(){ 
        ...
        <section className='aboutPage'>
         <div ref={this.div1} className={active[0]? 'aboutContent active' : 'aboutContent'}>
         At L'Atelier Design, we believe that everyone should feel good at home. You deserve a space that reflects who you are and makes you feel good when you're there.
         We love to work closely with our clients to create customized interiors that are cozy and timeless. Always attentive to your unique needs, tastes, lifestyle and work habits.</div>
